        ...
        <View style={{ flex: 1, padding: 20 }}>
            ...
            {state.data === null ?
                <TouchableOpacity onPress={() => handleAddService()}>
                    <Text style={{ margin: 50, backgroundColor: 'gray', borderRadius: 20, padding: 15, textAlign: 'center', fontSize: 20, fontWeight: 600, }}>Add</Text>
                </TouchableOpacity>
                :
                <TouchableOpacity onPress={() => handleUpdateService()}>
                    <Text style={{ margin: 50, backgroundColor: 'gray', borderRadius: 20, padding: 15, textAlign: 'center', fontSize: 20, fontWeight: 600, }}>Update</Text>
                </TouchableOpacity>
            }
        </View>
    )
